...
import zzw.bean.PicUploadResult;
import zzw.service.PropertieService;
...
public class PicUploadController {
    ...
    public String upload(@RequestParam("uploadFile") MultipartFile uploadFile,
        ...
        //http://image/taotao.com/images/2017/09/12/11121212312.jpg
        // 生成图片的绝对引用地址
        ...
        //使用mapper将java对象序列化为string类型的json数据
        return mapper.writeValueAsString(fileUploadResult);
    }

    //这是生成保存图片的路径名: PATH\\images\\yyyy\\MM\\dd\\yyyyMMddhhmmssSSSS+random.jpg
